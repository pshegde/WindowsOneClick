...
{
		partial class OneButtonAppCred
		{
				/// <summary>
				...
				{
						System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(OneButtonAppCred));
						...
						this.Name = "OneButtonAppCred";
						this.Text = "One-Button Credential";
						this.Load += new System.EventHandler(this.OneButtonAppCred_Load);
						this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.OneButtonAppCred_FormClosing);
